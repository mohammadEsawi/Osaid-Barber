...
INSERT INTO users (full_name, email, phone, password_hash, role) VALUES
  ('أحمد الأدمن', 'admin@osaidbarber.com', '+972515718974', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeuFm7YKDjnKfcv2i', 'admin')
ON CONFLICT (email) DO NOTHING;

-- Barber users (password: Admin@123)
INSERT INTO users (full_name, email, phone, password_hash, role) VALUES
  ('أسيد دويكات', 'osaid@osaidbarber.com', '+972509000001', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeuFm7YKDjnKfcv2i', 'barber'),
  ('أنس دويكات',  'anas@osaidbarber.com',  '+972509000002', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeuFm7YKDjnKfcv2i', 'barber')
ON CONFLICT (email) DO NOTHING;

-- Barber profiles
INSERT INTO barbers (user_id, bio, experience_years, is_active) VALUES
  ((SELECT id FROM users WHERE email='osaid@osaidbarber.com'), 'حلاق محترف بخبرة 8 سنوات في تصفيف الشعر وتشكيل اللحى', 8, true),
  ((SELECT id FROM users WHERE email='anas@osaidbarber.com'),  'متخصص في قصات الشعر العصرية والكلاسيكية مع خبرة 5 سنوات', 5, true)
...
INSERT INTO services (name, description, price, duration_minutes, is_active) VALUES
  ('حلاقة راس ولحية',    'حلاقة الرأس واللحية معاً بأسلوب احترافي',    30.00, 45, true),
  ...
  ('قص شعر الأطفال',     'قصة شعر للأطفال دون 12 سنة',                  20.00, 15, true),
